...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <form class="form-inline my-2 my-lg-0" action="/WWI/WWI/pages/Search.php">
        <input style="margin-left: 5px" class="form-control mr-sm-2" type="search" placeholder="Zoeken" required
               aria-label="Search" name="name"
               id="Zoeken">
        <button style="margin-left: 5px" class="btn btn-sample btn-sample-success" type="submit">Zoeken <i
